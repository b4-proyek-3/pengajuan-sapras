    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="container mx-auto mt-6">
            ...
            <div class="flex justify-end -mb-px">
                <button id="diajukanBtn" onclick="showCard('diajukan')"
                    class="tab-button bg-white text-gray-800 font-bold py-2 px-6 rounded-t-lg shadow-md mr-2">Diajukan</button>
                <button id="riwayatBtn" onclick="showCard('riwayat')"
                    ...
                    <form method="GET" action="{{ route('pengajuan.index') }}" class="flex justify-between items-center">
                        ...
                        <div class="relative flex items-center space-x-2">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                class="pl-8.75 text-sm border border-gray-300 rounded-md p-2 w-full" placeholder=" Cari">
                            @if (request('search') || request('sort_status'))
                                <a href="{{ route('pengajuan.index') }}"
                                    class="bg-gray-600 text-white py-2 px-4 rounded-md ml-4">Reset</a>
                            @endif
                        </div>
                    </form>
                </div>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" name="waktu_pinjam" id="waktu_pinjam" class="form-control"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_tempat" id="id_tempat" class="form-control" required>
                                            ...
                                            @foreach ($tempatList as $tempat)
                                                <option value="{{ $tempat->id_tempat }}">{{ $tempat->nama_gedung }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url" name="link_gdrive" id="link_gdrive" class="form-control"
                                            placeholder="https://drive.google.com/drive/folders/surat_izin_orang_tua">
                                    </div>
                    ...
                    <div class="bg-gray-100 p-4 border-b border-gray-300">
                        <form method="GET" action="{{ route('pengajuan.index') }}"
                            ...
                            <div class="relative flex items-center space-x-2">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}"
                                    class="pl-8.75 text-sm border border-gray-300 rounded-md p-2 w-full"
                                    placeholder=" Cari">
                                @if (request('search') || request('sort_status'))
                                    <a href="{{ route('pengajuan.index') }}"
                                        class="bg-gray-600 text-white py-2 px-4 rounded-md ml-4">Reset</a>
