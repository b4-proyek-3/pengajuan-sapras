...
<main class="flex items-center justify-center h-screen bg-gray-100">
    <section class="relative flex flex-col lg:flex-row w-full max-w-4xl h-auto lg:h-[30rem] rounded-3xl overflow-hidden shadow-lg">
        ...
        <div class="w-full lg:w-1/2 flex flex-col p-10 bg-white relative">
            ...
            <!-- Reset Password Form -->
            <div id="resetPasswordForm" class="absolute inset-0 transform translate-x-full transition-transform duration-700 ease-in-out flex-col justify-between p-10 bg-white hidden">
                <div class="title mb-6">
            ...
            <!-- Success Message -->
            <div id="resetSuccess" class="absolute inset-0 hidden flex-col justify-center items-center p-10 text-center">
