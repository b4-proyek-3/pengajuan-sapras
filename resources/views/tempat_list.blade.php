...
<div class="w-full px-6 py-6 mx-auto">
    <div class="bg-gray-50 min-h-screen">
        ...
        <!-- Main Content -->
        <div class="px-6 py-4">
            <h1 class="text-lg md:text-2xl font-semibold text-gray-900 mb-6">Pengajuan Sarana dan Prasarana</h1>
            ...
            <div class="bg-white rounded-b-lg shadow p-6">
                    <form action="{{ route('dashboard.index') }}" method="GET" class="grid grid-cols-12 gap-2 md:gap-4">
                        <!-- Building Selection -->
                        <div class="col-span-12 md:col-span-4">
                            <div class="relative">
                                <select name="gedung" id="gedung" class="w-full h-11 pl-4 pr-8 bg-white rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 appearance-none text-xs md:text-sm">
                        ...
                        <div class="col-span-12 md:col-span-5">
                            <div class="relative">
                                <input type="text"
                                    id="daterange"
                                    name="daterange"
                                    class="w-full h-11 pl-4 pr-4 bg-white rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 text-xs md:text-sm"
                        ...
                        <div class="col-span-12 md:col-span-3 flex justify-end">
                            <button class="w-full md:w-auto bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-800 focus:ring-2 focus:ring-indigo-400 text-sm md:text-base">
                                Cari
                            </button>
                        </div>
                    </form>
                            ...
                            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow duration-200">
                                <div class="flex flex-wrap md:flex-nowrap gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-blue-600 text-xs md:text-sm">{{ $ruangan->gedung->nama_gedung }}</p>
                                        <p class="mt-2 text-gray-600 text-xs md:text-sm">
                                        ...
                                        @if($ruangan->menggunakanRuangan->count())
                                            ...
                                            @endforeach
                                        @else
                                            <p class="mt-2 text-gray-500 text-xs md:text-sm">Belum ada penggunaan</p>
                                        @endif
                                    </div>

                                    <!-- Status dan Tombol -->
                                    <div class="md:items-center md:flex-row gap-2 ml-6 flex flex-col items-end justify-between">
                                    <div id="roomStatusLabel" style="font-weight: bold; margin-top: 10px;"></div>
                                    <button
                                            class="px-4 py-2 text-sm md:text-base mt-2 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 btn btn-primary detail-button"
