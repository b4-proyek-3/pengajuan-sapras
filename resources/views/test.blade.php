    ...
    <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
      <div class="flex flex-wrap mt-0 -mx-3">
        <div class="flex-none w-full max-w-full px-3 mt-0 lg:w-full lg:flex-none">
          <h6 class="text-xl font-bold">Edit Pengajuan</h6>
      ...
      <!-- Garis oranye -->
      <div class="mt-2" style="border-bottom: 2px solid #f97316;"></div>
    </div>
    <div class="flex-auto p-6">
      <!-- Form untuk input data pengajuan -->
      <form class="space-y-4">
        <!-- Baris input form -->
        <div class="flex items-center mb-4">
          <label for="nama-kegiatan" class="w-1/3 text-right pr-4 text-sm font-medium">Nama Kegiatan</label>
          <input type="text" id="nama-kegiatan" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="tanggal-kegiatan" class="w-1/3 text-right pr-4 text-sm font-medium">Tanggal Kegiatan</label>
          <input type="date" id="tanggal-kegiatan" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="tempat-kegiatan" class="w-1/3 text-right pr-4 text-sm font-medium">Tempat Kegiatan</label>
          <input type="text" id="tempat-kegiatan" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="kategori-kegiatan" class="w-1/3 text-right pr-4 text-sm font-medium">Kategori Kegiatan</label>
          <input type="text" id="kategori-kegiatan" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="nama-pengaju" class="w-1/3 text-right pr-4 text-sm font-medium">Nama Pengaju</label>
          <input type="text" id="nama-pengaju" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="kontak" class="w-1/3 text-right pr-4 text-sm font-medium">Kontak</label>
          <input type="text" id="kontak" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>
        <div class="flex items-center mb-4">
          <label for="ormawa" class="w-1/3 text-right pr-4 text-sm font-medium">Ormawa</label>
          <input type="text" id="ormawa" class="w-2/3 p-2 border border-gray-300 rounded focus:ring focus:ring-blue-300 outline-none text-sm" />
        </div>

        <!-- Tombol Simpan dan Batal -->
        <div class="flex justify-center space-x-4 mt-6">
          <button type="button" class="px-4 py-2 bg-orange-400 text-white rounded-lg hover:bg-orange-500 transition flex items-center text-sm">
            <i class="fa fa-times-circle mr-2"></i> <!-- Ikon BATALKAN -->
            BATALKAN
          </button>
          <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition flex items-center text-sm">
            <i class="fa fa-check-circle mr-2"></i> <!-- Ikon SIMPAN -->
            SIMPAN
          </button>
        </div>
      </form>
...
<!-- CSS untuk tampilan tombol dan input -->
<style>
  body {
  ...
  input {
    padding: 8px;
    font-size: 14px; /* Ukuran font input diatur lebih besar */
  }
  ...
  input[type="text"], input[type="date"] {
    ...
    border-radius: 6px;
    padding: 10px; /* Padding input ditingkatkan untuk kenyamanan */
    font-size: 14px; /* Ukuran font input diatur lebih besar */
  }
  ...
  .space-y-4 > * + * {
    margin-top: 16px; /* Spasi antar elemen input diperbesar */
  }
