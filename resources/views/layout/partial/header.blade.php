<!-- sidenav  -->
<aside
    class="max-w-62.5 ease-nav-brand z-50 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent bg-white">
    <div class="h-19.5">
        ...
        <ul class="flex flex-col pl-0 mb-0">
                  ...
                  px-4 font-semibold transition-colors"
                    ...
                    <div
                        class="{{ request()->routeIs('dashboard')
                            ...
                            : 'bg-white shadow-soft-2xl hover:shadow-md' }} 
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('pengajuan.index', 'reviewer.index') ? 'shadow-lg bg-white text-slate-700 ring-2 ring-purple-200 transition-all duration-300 transform hover:scale-105' : 'text-slate-700 hover:shadow-md' }} 
                  py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg 
                  px-4 font-semibold transition-colors"
                    href="{{ auth()->user()->pengaju ? route('pengajuan.index') : route('reviewer.index') }}">
                    <div
                        class="{{ request()->routeIs('pengajuan.index', 'reviewer.index')
                            ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl scale-105'
                            : 'bg-white shadow-soft-2xl hover:shadow-md' }} 
                            mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('pengajuan.index', 'reviewer.index') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                ...
                px-4 font-semibold transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('layout.status') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class=""
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('ormawa.index') ? 'shadow-lg bg-white text-slate-700 ring-2 ring-purple-200 transition-all duration-300 transform hover:scale-105' : 'text-slate-700 hover:shadow-md' }} 
                py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg 
                px-4 font-semibold transition-colors"
                    href="{{ route('ormawa.index') }}">
                    <div
                        class="{{ request()->routeIs('ormawa.index')
                            ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl scale-105'
                            : 'bg-white shadow-soft-2xl hover:shadow-md' }}
                          mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('ormawa.index') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class=""
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('users.index') ? 'shadow-lg bg-white text-slate-700 ring-2 ring-purple-200 transition-all duration-300 transform hover:scale-105' : 'text-slate-700 hover:shadow-md' }} 
                py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg 
                px-4 font-semibold transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('users.index') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class=""
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('ruangan.index') ? 'shadow-lg bg-white text-slate-700 ring-2 ring-purple-200 transition-all duration-300 transform hover:scale-105' : 'text-slate-700 hover:shadow-md' }} 
                py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg 
                px-4 font-semibold transition-colors"
                    href="{{ route('ruangan.index') }}">
                    <div
                        class="{{ request()->routeIs('ruangan.index')
                            ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl scale-105'
                            : 'bg-white shadow-soft-2xl hover:shadow-md' }}
                          mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('ruangan.index') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class=""
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kelola Tempat</span>
                </a>
            </li>

            <li class="mt-0.5 w-full">
                <a class="{{ request()->routeIs('jadwal.index') ? 'shadow-lg bg-white text-slate-700 ring-2 ring-purple-200 transition-all duration-300 transform hover:scale-105' : 'text-slate-700 hover:shadow-md' }} 
                py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg
                px-4 font-semibold transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill="{{ request()->routeIs('jadwal.index') ? '#FFFFFF' : '#000000' }}"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class=""
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kelola Jadwal</span>
                </a>
            </li>
            @endif
        </ul>
            ...
            <nav>
                ...
                <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                    ...
                    <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                        aria-current="page">
                        @if (request()->routeIs('pengajuan.index'))
                            Pengajuan
