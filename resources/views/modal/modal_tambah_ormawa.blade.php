<div class="modal fade overflow-y-auto" id="ormawaModal" tabindex="-1" aria-labelledby="ormawaModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ormawaModalLabel">Form Tambah Ormawa</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('ormawa.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_ormawa" id="nama_ormawa" class="form-control" required>
                    </div>
