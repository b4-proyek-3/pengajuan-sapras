                      ...
                      <td class="p-2 align-middle bg-transparent whitespace-nowrap">
                          <div class="flex px-4 py-1">
                              ...
                              <div class="flex flex-col justify-center pl-2">
                                  <h6 class="mb-0 text-sm leading-normal">{{ $pengajuan->nama_ketuplak ?? 'N/A' }}</h6>
                              </div>
                          </div>
                      </td>
                  </tr>
                  <tr>
                      <td class="p-2 align-middle bg-transparent whitespace-nowrap">
                          <div class="flex px-4 py-1">
                              ...
                              <div class="flex flex-col justify-center pl-2">
                                  <h6 class="mb-0 text-sm leading-normal">{{ $pengajuan->notelp ?? 'N/A' }}</h6>
                              </div>
                          </div>
                      </td>
                  </tr>
                  ...
                  <tr>
                      <td class="p-2 align-middle bg-transparent whitespace-nowrap">
                          <div class="flex px-4 py-1">
                              ...
                              <div class="flex flex-col justify-center pl-2">
                                  <h6 class="mb-0 text-sm leading-normal">{{ str_replace('proker', 'Program Kerja', ucfirst($pengajuan->jenis_kegiatan) ?? 'N/A') }}</h6>
                              </div>
                          </div>
                      </td>
                  </tr>
                  ...
                  <tr>
                      <td class="p-2 align-middle bg-transparent whitespace-nowrap">
                          <div class="flex px-4 py-1">
                              ...
                              <div class="flex flex-col justify-center pl-2">
                                  <h6 class="mb-0 text-sm leading-normal">{{ $pengajuan->jumlah_peserta ?? 'N/A' }}</h6>
                              </div>
                          </div>
                      </td>
                  </tr>
                      ...
                      <td class="p-2 align-middle bg-transparent whitespace-nowrap">
                        <div class="flex px-4 py-1">
                          <div class="flex flex-col justify-center">
                            ...
                            <h6 class="mb-0 text-sm leading-normal">
                            @if (!is_null($pengajuan->link_drive))
        ...
        <div class="w-full max-w-full px-6 mb-6 mt-6">
          <form action="{{ route('update.review', ['id_pengajuan' => $pengajuan->id_pengajuan, 'id_reviewer' => $id_reviewer]) }}" method="POST">
            ...
            <div class="flex justify-end space-x-4">
                <select name="status" class="border border-gray-300 rounded-md p-2 w-full max-w-xs">
                ...
                <button type="submit" class="bg-gradient-to-tl from-blue-600 to-teal-400 px-4 text-sm rounded-lg py-3 text-white w-full max-w-xs">
                    Submit
                </button>
            </div>
            @endif
